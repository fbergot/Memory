...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _assets_CSS_index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assets/CSS/index.css */ \"./src/assets/CSS/index.css\");\n/* harmony import */ var _assets_JS_game_game__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/JS/game/game */ \"./src/assets/JS/game/game.js\");\n\n\n\nvar $ = function $(tag, isAll) {\n  return isAll ? document.querySelectorAll(tag) : document.querySelector(tag);\n};\n\nvar board = $(\"#container\");\nvar score = $(\"#score\");\nvar life = $(\"#life\");\nvar dataCards = (0,_assets_JS_game_game__WEBPACK_IMPORTED_MODULE_1__.buildArrayCards)(8);\nvar shuffleDataCards = (0,_assets_JS_game_game__WEBPACK_IMPORTED_MODULE_1__.shuffleArray)(dataCards);\n(0,_assets_JS_game_game__WEBPACK_IMPORTED_MODULE_1__.setBoard)(board, shuffleDataCards);\nvar cards = $(\".card img\", true);\nvar state = [];\n\nvar handleClickImg = function handleClickImg(event) {\n  if (state[0]) {\n    if (Number(state[0].dataset.id) === Number(event.target.dataset.id)) {\n      alert(\"gagner\");\n      state = [];\n      event.target.classList.remove(\"initCard\");\n    } else {\n      window.setTimeout(function () {\n        state[0].classList.add(\"initCard\");\n        state[1].classList.add(\"initCard\");\n      }, 1000);\n      state = [];\n    }\n  }\n\n  state.push(event.target);\n  event.target.classList.remove(\"initCard\");\n};\n\n(0,_assets_JS_game_game__WEBPACK_IMPORTED_MODULE_1__.setAddEventListener)(cards, handleClickImg);\n\n//# sourceURL=webpack://memory/./src/app.js?");
